...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Certificados /</span> Projects
        </h4>

        <div class="card p-0 mb-4">
            <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
                <div class="app-academy-md-25 card-body py-0">
                    <img src="{{ asset('img/illustrations/bulb-light.png') }}"
                        class="img-fluid app-academy-img-height scaleX-n1-rtl" alt="Bulb in hand"
                        data-app-light-img="{{ asset('img/illustrations/bulb-light.png')}}"
                        data-app-dark-img="{{ asset('img/illustrations/bulb-dark.png')}}" height="90">
                </div>
                ...
                <div class="app-academy-md-25 d-flex align-items-end justify-content-end">
                    <img src="{{ asset('img/illustrations/pencil-rocket.png') }}" alt="pencil rocket" height="188"
                        class="scaleX-n1-rtl">
                </div>
            </div>
        </div>
                ...
                <div class="card">
                        ...
                        <div class="d-flex align-items-start">
                            <div class="d-flex align-items-start">
                                <div class="avatar me-3">
                                    <img src="{{ asset('img/icons/brands/social-label.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="me-2">
                                    <h5 class="mb-1"><a href="javascript:;" class="stretched-link text-heading">Social
                                            Banners</a>
                                    </h5>
                                    <div class="client-info text-body"><span class="fw-medium">Client:
                                        </span><span>Christian
                                            Jimenez</span></div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$24.8k</span> <span>/ $18.2k</span>
                                </p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                                <p class="mb-1"><span class="text-heading fw-medium">Start Date: </span>
                                    <span>14/2/21</span>
                                </p>
                                <p class="mb-1"><span class="text-heading fw-medium">Deadline: </span>
                                    <span>28/2/22</span>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="card-body border-top">
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-1"><span class="text-heading fw-medium">All Hours: </span> <span>380/244</span>
                            </p>
                        ...
                        <div class="progress mb-3 rounded rounded" style="height: 8px;">
                            <div class="progress-bar rounded" role="progressbar" style="width: 95%;" aria-valuenow="95"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto">
                                <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i
                                        class="mdi mdi-message-outline mdi-24px me-2"></i>15</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header pb-2">
                        <div class="d-flex align-items-start">
                            <div class="d-flex align-items-start">
                                <div class="avatar me-3">
                                    <img src="{{ asset('img/icons/brands/react-label.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="me-2">
                                    <h5 class="mb-1"><a href="javascript:;" class="stretched-link text-heading">Admin
                                            Template</a>
                                    </h5>
                                    <div class="client-info text-body"><span class="fw-medium">Client:
                                        </span><span>Jeffrey
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$2.4k</span> <span>/ 1.8k</span>
                                </p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                    ...
                    <div class="card-body border-top">
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-1"><span class="text-heading fw-medium">All Hours: </span> <span>98/135</span>
                            </p>
                        ...
                        <div class="progress mb-3 rounded rounded" style="height: 8px;">
                            <div class="progress-bar rounded" role="progressbar" style="width: 42%;" aria-valuenow="42"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center">
                                <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <img class="rounded-circle" src="{{ asset('img/avatars/15.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="John Doe" class="avatar avatar-sm pull-up">
                                        <img class="rounded-circle" src="{{ asset('img/avatars/1.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="Alan Walker" class="avatar avatar-sm pull-up me-2">
                                        <img class="rounded-circle" src="{{ asset('img/avatars/16.png') }}"
                                            alt="Avatar">
                                    </li>
                            ...
                            <div class="ms-auto">
                                <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i
                                        class="mdi mdi-message-outline mdi-24px me-2"></i> 236</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header pb-2">
                        <div class="d-flex align-items-start">
                            <div class="d-flex align-items-start">
                                <div class="avatar me-3">
                                    <img src="{{ asset('img/icons/brands/vue-label.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="me-2">
                                    <h5 class="mb-1"><a href="javascript:;" class="stretched-link text-heading">App
                                            Design</a></h5>
                                    <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Ricky
                                            McDonald</span></div>
                                </div>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card-body border-top">
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-1"><span class="text-heading fw-medium">All Hours: </span> <span>880/421</span>
                            </p>
                        ...
                        <div class="progress mb-3 rounded rounded" style="height: 8px;">
                            <div class="progress-bar rounded" role="progressbar" style="width: 68%;" aria-valuenow="68"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center">
                                <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <img class="rounded-circle" src="{{ asset('img/avatars/4.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="Kristi Lawker" class="avatar avatar-sm pull-up">
                                        <img class="rounded-circle" src="{{ asset('img/avatars/2.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="Danny Paul" class="avatar avatar-sm pull-up me-2">
                                        <img class="rounded-circle" src="{{ asset('img/avatars/7.png') }}"
                                            alt="Avatar">
                                    </li>
                            ...
                            <div class="ms-auto">
                                <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i
                                        class="mdi mdi-message-outline mdi-24px me-2"></i> 98</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header pb-2">
                        <div class="d-flex align-items-start">
                            <div class="d-flex align-items-start">
                                <div class="avatar me-3">
                                    <img src="{{ asset('img/icons/brands/html-label.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="me-2">
                                    <h5 class="mb-1"><a href="javascript:;" class="stretched-link text-heading">Create
                                            Website</a>
                                    </h5>
                                    <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Hulda
                                            Wright</span></div>
                                </div>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$8.5k</span> <span>/ $2.43k</span>
                                </p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                    ...
                    <div class="card-body border-top">
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-1"><span class="text-heading fw-medium">All Hours: </span>
                                <span>1.2k/820</span>
                            </p>
                        ...
                        <div class="progress mb-3 rounded" style="height: 8px;">
                            <div class="progress-bar rounded" role="progressbar" style="width: 72%;" aria-valuenow="72"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center">
                                <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">
                                    ...
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <img class="rounded-circle" src="{{ asset('img/avatars/9.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                            ...
                            <div class="ms-auto">
                                <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i
                                        class="mdi mdi-message-outline mdi-24px me-2"></i> 120</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header pb-2">
                        <div class="d-flex align-items-start">
                            <div class="d-flex align-items-start">
                                <div class="avatar me-3">
                                    <img src="{{ asset('img/icons/brands/figma-label.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="me-2">
                                    <h5 class="mb-1"><a href="javascript:;" class="stretched-link text-heading">Figma
                                            Dashboard</a>
                                    </h5>
                                    <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Jerry
                                            Greene</span></div>
                                </div>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$52.7k</span> <span>/ $28.4k</span>
                                </p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                    ...
                    <div class="card-body border-top">
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-1"><span class="text-heading fw-medium">All Hours: </span> <span>142/420</span>
                            </p>
                        ...
                        <div class="progress mb-3 rounded" style="height: 8px;">
                            <div class="progress-bar rounded" role="progressbar" style="width: 35%;" aria-valuenow="35"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center">
                                <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <img class="rounded-circle" src="{{ asset('img/avatars/10.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="Sam D'souza" class="avatar avatar-sm pull-up">
                                        <img class="rounded-circle" src="{{ asset('img/avatars/13.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                            ...
                            <div class="ms-auto">
                                <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i
                                        class="mdi mdi-message-outline mdi-24px me-2"></i> 20</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header pb-2">
                        <div class="d-flex align-items-start">
                            <div class="d-flex align-items-start">
                                <div class="avatar me-3">
                                    <img src="{{ asset('img/icons/brands/xd-label.png') }}" alt="Avatar"
                                        class="rounded-circle">
                                </div>
                                <div class="me-2">
                                    <h5 class="mb-1"><a href="javascript:;" class="stretched-link text-heading">Logo
                                            Design</a></h5>
                                    <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Olive
                                            Strickland</span></div>
                                </div>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$1.3k</span> <span>/ $655</span>
                                </p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                    ...
                    <div class="card-body border-top">
                        <div class="d-flex align-items-center mb-3">
                            <p class="mb-1"><span class="text-heading fw-medium">All Hours: </span> <span>580/445</span>
                            </p>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center">
                                <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <img class="rounded-circle" src="{{ asset('img/avatars/3.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                            ...
                            <div class="ms-auto">
                                <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i
                                        class="mdi mdi-message-outline mdi-24px me-2"></i> 16</a>
                            </div>
                        </div>
                    </div>
                </div>
